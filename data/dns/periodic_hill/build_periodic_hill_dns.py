...
Usage:
    python data/dns/periodic_hill/build_periodic_hill_dns.py
    python data/dns/periodic_hill/build_periodic_hill_dns.py --input-dir data/dns/periodic_hill \
        --out data/dns/periodic_hill/periodic_hill_dns.csv
    python data/dns/periodic_hill/build_periodic_hill_dns.py --format ascii
"""
...
def main() -> None:
    ...
    ap.add_argument("--input-dir", type=Path, default=Path("data/dns/periodic_hill"),
