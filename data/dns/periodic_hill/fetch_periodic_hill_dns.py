...
Usage:
    python data/dns/periodic_hill/fetch_periodic_hill_dns.py
    python data/dns/periodic_hill/fetch_periodic_hill_dns.py --out-dir data/dns/periodic_hill --keep-raw
    python data/dns/periodic_hill/fetch_periodic_hill_dns.py --cases alph10-9-3036 alph05-4071-2024
"""
